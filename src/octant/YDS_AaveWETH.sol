...
/// @title YDS_AaveWETH
/// @notice Yield-Donating Strategy for WETH via AjeyVault
/// @dev Wraps AjeyVault to donate yield while preserving principal
contract YDS_AaveWETH is BaseStrategy {
    ...
    constructor(AjeyVault _ajeyVault, address _donationAddress, address _admin)
        BaseStrategy(_ajeyVault.asset(), _donationAddress, "YDS Aave WETH", "ydsAaveWETH")
    {
